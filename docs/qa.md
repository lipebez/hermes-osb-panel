...
This protocol verifies the repository and local fixture behavior. It does **not** prove a clean-host Git installation, production Hermes compatibility, a production OSB adapter, or an OSB release-version compatibility range. Hermes development/dashboard behavior was validated in local fixture QA against Hermes Agent v0.19.0 (2026.7.20).
